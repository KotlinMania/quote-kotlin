...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Quote.swiftmodule/`
...
//      `import Quote` above would fail at compile time.
//
//   2. The static archive `libQuote.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Quote" }` and
//      `flattenPackage = "io.github.kotlinmania.quote"` configuration in
