...
| 3 | `runtime` | `quote.Runtime [PROVENANCE-FALLBACK]` | 0.42 | 0 | 21/23 matched (target 120) | `span`, `fmt` | 16/17 matched (target 16) | `IdentFragmentAdapter` | 3 | 40 | 34005.8 |
| 4 | `spanned` | `quote.Spanned [PROVENANCE-FALLBACK]` | 0.89 | 0 | 2/2 matched (target 4) | _none_ | 1/2 matched (target 1) | `Sealed` | 1 | 4 | 10401.1 |
| 5 | `ext` | `quote.Ext [PROVENANCE-FALLBACK]` | 0.83 | 0 | 7/7 matched (target 11) | _none_ | 2/2 matched | _none_ | 0 | 9 | 901.7 |
