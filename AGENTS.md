...
This file is the quick-reference operating contract for quote-kotlin. The longer
...
quote-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`quote`](https://crates.io/crates/quote). Upstream Rust is the behavioral oracle while the
